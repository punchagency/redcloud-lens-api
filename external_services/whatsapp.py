...
class WhatsappService:
    ...
    def is_whitelisted(self, business_account_id: str, phone_number_id: str):
        return self.is_business_account_whitelisted(business_account_id) and self.is_phone_number_whitelisted(phone_number_id)
